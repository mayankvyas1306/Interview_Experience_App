        ...
        <div className="glass glow-border rounded-4 px-3 px-md-4 py-3">
          <div className="d-flex align-items-center justify-content-between gap-3">
            ...
            <div className="d-none d-md-flex align-items-center gap-2">
              <Link
                href="/explore"
                className={`text-decoration-none px-3 py-2 rounded-3 ${isActive("/explore") ? "glass text-light" : "text-muted2"
                  }`}
              >
              ...
              <Link
                href="/analytics"
                className={`text-decoration-none px-3 py-2 rounded-3 ${isActive("/analytics") ? "glass text-light" : "text-muted2"
                  }`}
              >
              ...
              <Link
                href="/create"
                className={`text-decoration-none px-3 py-2 rounded-3 ${isActive("/create") ? "glass text-light" : "text-muted2"
                  }`}
              >
